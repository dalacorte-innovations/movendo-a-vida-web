    ...
    <div className="flex flex-col bg-primaryBlack min-h-screen relative">
          ...
          >
            <div className="text-white text-center max-w-xl md:max-w-4xl p-4 flex flex-col items-center justify-center -mt-16 lg:-mt-96">
              <h1 className="text-2xl md:text-4xl font-bold mb-4 md:mb-6 leading-tight">
                Transforme seus valores <br /> em metas alcançáveis
              </h1>
      ...
      <section className="w-full bg-cover bg-center py-20" style={{ backgroundImage: `url(${BackgroundBeneficios})` }}>
        <div className="text-center mb-12 px-4">
          <h2 className="text-3xl md:text-5xl font-metropolis">Benefícios</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-8 max-w-7xl mx-auto">
          <div className="bg-white rounded-2xl p-6 shadow-md flex items-start space-x-4">
            ...
            <div>
              <h3 className="text-xl font-semibold mb-2">Gráficos Personalizados</h3>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-md flex items-start space-x-4">
            ...
            <div>
              <h3 className="text-xl font-semibold mb-2">Planos Documentados</h3>
              <p className="text-gray-700 text-base">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-md flex items-start space-x-4">
            ...
            <div>
              <h3 className="text-xl font-semibold mb-2">Investimento para o Futuro</h3>
              <p className="text-gray-700 text-base">
      ...
      <section className="w-full bg-primaryBlack py-16 px-4">
          <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-white mx-auto">
                  O que nossos investidores estão falando
              </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {[...Array(6)].map((_, index) => {
                  const users = [
                      { name: "Mariana Oliveira", profession: "Empresária" },
                      { name: "Paulo Ferreira", profession: "Consultor Financeiro" },
                      { name: "Ana Clara Souza", profession: "Engenheira" },
                      { name: "Rafael Menezes", profession: "Advogado" },
                      { name: "Júlia Albuquerque", profession: "Médica" },
                      { name: "Lucas Martins", profession: "Desenvolvedor de Software" }
                  ];
                      ...
                      <div key={index} className="bg-gradient-to-b from-[#0A0A0A80] to-[#1C1C1C80] border border-gray-600 rounded-3xl p-6 shadow-lg flex flex-col justify-between">
                          ...
                          <p className="text-thirdGray text-sm mb-2">
                              {index === 0
                                  ...
                                  : index === 2
                                  ? "Nunca foi tão fácil definir metas de longo prazo e trabalhar para alcançá-las. Recomendo para todos!"
                                  : index === 3
                                  ...
                                  : "Muito fácil de usar e extremamente útil para manter o foco nas minhas metas pessoais e profissionais."}
                          </p>
      ...
      <section
          className="w-[90%] mx-auto py-12 mb-16 flex justify-center items-center rounded-[2rem]"
          style={{
            backgroundImage: `url(${BackgroundFutureButton})`,
      ...
      <section
        ...
        <div className="text-center max-w-2xl">
            <h2 className="text-2xl font-semibold text-white mb-4">Pronto para transformar seu futuro?</h2>
            <p className="text-thirdGray text-base mb-6">
                Não espere mais para começar sua jornada rumo ao sucesso.
            </p>
            <div className="flex justify-center gap-4 mb-6">
                <button className="bg-blue-500 text-white font-semibold px-6 py-2 rounded-xl"
                    onClick={() => navigate('/login')}
                >
                    Fazer login
                </button>
                <button className="bg-white text-black font-semibold px-6 py-2 rounded-xl"
                    onClick={() => navigate('/register')}
                >
                    Cadastre-se
                </button>
          ...
          <footer className="w-[90%] md:w-[80%] flex flex-col justify-center items-center text-white text-sm px-4 mt-14">
              ...
              <div className="w-full flex justify-between items-center">
                  <span>© 2024 | Desenvolvido por Dalacorte Innovations</span>
